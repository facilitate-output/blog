...
3. 过去几个月（2021-08-23）陪伴 30+ 伙伴前行的过程，我发现在通往蓬勃人生路上，有很多共性现象，在输出实验室各期/各组里重复出现。最常见的：

    > 很多人发现自己目标没达成，第一反应是自己执行力不足，然后去找提升执行力，或找时间管理、精力管理或对抗拖延、分心的方法，或强逼着自己加班加点达成所定目标。结果常是困扰很久也没有实质改善…很少有人去反思，是不是一开始目标就没定好。

    但其实**选择比努力更重要**。这个过程很类似企业，如果一开始战略方向选错，那做再多努力也易徒劳。

而我的优势偏目标管理，且
选的切入点，或者说想为用户提供的价值是：助力有需要的伙伴聚焦要事、输出价值，更快更稳地实现目标、奔向蓬勃人生。

此外，人和外界的互动，其实都可以抽象为 “输入-处理-输出”（见下图） ，而关注“输出”、以输出带动输入，是一种很高效的学习成长和实现目标的方式。
